    ...
    <div class="divide-y divide-gray-200">
        <div class="grid grid-cols-12 gap-3 text-base">
            ...
            <div class="col-span-1 mt-8">
                <a href="generatepdf/{{$idproducto}}" class="border border-red-500 bg-red-500 text-xl w-12 text-white rounded-md px-4 py-1 transition duration-500 ease select-none hover:bg-red-600 focus:outline-none focus:shadow-outline ">
